...
The code that performs the reconnecting logic is: `ReconnectingCordaRPCOps.kt <|os_samples_branch|/net/corda/client/rpc/internal/ReconnectingCordaRPCOps.kt>`_.
...
The usage is showcased in the: `RpcReconnectTests.kt <|os_samples_branch_name|/node/src/integration-test/kotlin/net/corda/node/services/rpc/RpcReconnectTests.kt>`_.
